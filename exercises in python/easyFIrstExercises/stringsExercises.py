item1 = "salad"
item2 = "eggs"
# CR: Extra credit: String formatting can be very useful in these cases. There are two ways to do this, both of which indicate placeholders in the original string.
